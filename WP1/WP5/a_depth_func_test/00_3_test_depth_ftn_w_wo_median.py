...
#     print(idxs_11.sum(), idxs_21.sum(), idxs_11_sp.sum(), idxs_21_sp.sum())
    ...
    plt.ioff()
    plt.scatter(refr_pts[:, 0], refr_pts[:, 1], c=depths_1,
                cmap=plt.get_cmap('Blues'))

    plt.scatter(refr_pts[:, 0][depth_below_5],
                refr_pts[:, 1][depth_below_5], c='k')
    plt.scatter(refr_pts[:, 0][idxs_11],
                refr_pts[:, 1][idxs_11], c='r')
    plt.show()
    depths_1[idxs_21]
    depths_2[idxs_21]
    depths_3[idxs_21]
